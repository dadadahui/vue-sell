  ...
  <div v-show="showFlag" class="food" ref="food">
    <div class="food-content">
      ...
      <div class="rating">
        ...
        <ratingselect @ratingtype-select="selectRatingType" @content-toggle="toggleContent" :select-type="selectType" :only-content="onlyContent" :desc="desc" :ratings= "food.ratings"></ratingselect>
